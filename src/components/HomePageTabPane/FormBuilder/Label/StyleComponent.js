...
const StyleComponent = ({ handleChangeValue, element }) => {
  ...
  const handleShowBackColorPicker = (e) => {
    ...
    <>
      <form>
        ...
        <div className="form-input">
          ...
          <div className="colorBoxStyleContainer">
            <div className="colorBoxStyle">
              <div
                className="colorBox"
                style={{ background: compactPicker }}
          ...
          <div
            className={
              showColorPicker == true
                ? "displayShowColorPicker "
                : "displayHideColorPicker"
            }
          >
            {/* <p className="secondaryColor">Text Color</p> */}
            <SketchPicker
              id="label-fill-box"
              onChange={(color) => {
        ...
        <div className="form-input">
          ...
          <div className="colorBoxStyleContainer">
            <div className="colorBoxStyle">
              <div
                ...
                onClick={(e) => handleShowBackColorPicker(e)}
                data-tip
                data-for="11"
          ...
          >
            {/* <p className="secondaryColor">Text Background Color</p> */}
            <SketchPicker
              id="label-bg-color-picker"
              onChange={(color) => {
