        ...
        >
          <form>
            ...
            <div className="form-checkbox-wrap">
              ...
              <label className="secondaryColor" htmlFor="scanner">
                <input type="checkbox" id="scanner" name="form-checkbox" />
                <span className="secondaryColor">
                  <Icon icon="bx:check" />
                </span>
                <p className="secondaryColor">enable Scanner</p>
              </label>
            </div>
            <div className="accessibility-wrap">
              <div className="accessibility-head-wrap">
                <h6 className="primaryColor">Accessibility</h6>
                <Link id="sectionProperties-accessibility-link" onClick={handleAccessibilityPopupShow} to="#">{t("explore")}</Link>
              </div>
