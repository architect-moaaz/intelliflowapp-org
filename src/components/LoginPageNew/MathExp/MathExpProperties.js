    ...
    if (showAccessibilityPopup == true) {
      return (
        <AccessibilityPopup
          ...
          id="mathExpProperties-handleAccessibilityPopupClose-AccessibilityPopup"
        />
      );
    }
  };
        ...
        >
          <form>
            <div className="form-input">
              <label className="secondaryColor">Type your Expression here</label>
              <MathView
                ref={keyboardRef}
                ...
                className="border"
                id="mathExpProperties-expressionHere-MathView"
              />
            </div>
            <div className="accessibility-wrap">
              <div className="accessibility-head-wrap">
                ...
                <Link
                to="#"
                  id="mathExpProperties-accessibility-link"
...
export default MathExpProperties;
