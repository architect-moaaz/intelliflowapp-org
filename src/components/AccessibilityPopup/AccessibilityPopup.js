...
const AccessibilityPopup = ({ layout, setLayout, handleHidePopup }) => {
  ...
  const [accessibilityData, setAccessibilityData] = useState(getElement());
  ...
  function getElement() {
    ...
    const temp = layout.layout.map((lay) => {
      if (lay.edit) {
        if (lay?.stack?.length) {
          const stackTemp = lay.stack.filter((stack) => stack.edit === true);

          if (stackTemp.length) {
            tempElement = { ...stackTemp[0] };
          }
        } else {
          tempElement = { ...lay };
        }
    ...
    return tempElement.accessibility;
  }
  ...
  const fetchUsersList = async (token) => {
    ...
    await axios(config)
      .then(function (response) {
        ...
        temparr.map((user) => {
          accessibilityData?.writeUsers?.map((currentUser) => {
            if (user.id == currentUser.id) {
              user.selectedForWrite = true;
            }
          });
          accessibilityData.readUsers.map((currentUser) => {
            if (user.id == currentUser.id) {
              user.selectedForRead = true;
            }
          });
          accessibilityData.hideUsers.map((currentUser) => {
            if (user.id == currentUser.id) {
  ...
  const fetchWorkgroupsList = async (token) => {
    ...
    await axios(config)
      .then(function (response) {
        ...
        // console.log("accdata",accessibilityData)

        temparr.map((group) => {
          accessibilityData?.writeGroups?.map((currentGroup) => {
            if (group.id == currentGroup.id) {
              group.selectedForWrite = true;
            }
          });
          accessibilityData.readGroups.map((currentGroup, index) => {
            if (group.id == currentGroup.id) {
              group.selectedForRead = true;
            }
          });
          accessibilityData.hideGroups.map((currentGroup) => {
            if (group.id == currentGroup.id) {
  ...
  const handleSaveClick = () => {
    ...
    //   if (e.edit == true) {
    //     e.accessibility = accessibilityTemp;
    //   }
    // });
            ...
            return {
              ...
              stack: item.stack?.map((stack) => {
                if (stack.edit) {
                  return {
                    ...stack,
                    accessibility: accessibilityTemp,
                  };
                }
                return stack;
              }),
  ...
  const displaySavedTable = () => {
    return (
      <Col xs={3} sm={3} md={3} lg={3}>
        <Card className="customCard accessibility-card">
          <Card.Header>
            <h6 className="accessibility-savedaction primaryColor">Saved Action</h6>
          </Card.Header>
          <Card.Body>
            <Form>
              {savedDataFromApi.length !== 0 ? (
                savedDataFromApi.map((data, index) => (
                  <>
                    <div className="mt-2">
                      <input
                        id="accessibilityPopup-savedActionName"
                        type="radio"
    ...
    >
      <Modal.Body className="modal-scroll">
        <Container className="px-2">
            ...
            <Col xs={12} sm={12} md={12} lg={12}>
              ...
              <Row className="my-2">
                ...
                <Col lg={4} md={4} sm={4} xs={4}>
                  ...
                  <div className="my-2 acessibility-pop-up">
                    {usersList.map((user, index) => {
                      if (
                        ...
                        return (
                          <div key={index} className="minibtn mx-2 my-1">
                            ...
                            <span
                              ...
                              id="accessibilityPopup-removeUser-span"
                            >
                              {crossIcon()}
                            </span>
                          </div>
                ...
                <Col lg={4} md={4} sm={4} xs={4}>
                  ...
                  <div className="my-2 accessibility-2">
                    {workgroupsList.map((workgroup, index) => {
                      if (
                        ...
                        return (
                          <div key={index} className="minibtn mx-2 my-1">
                            ...
                            <span
                              id="accessibilityPopup-crossIcon-removeWorkgroup"
                              className="mx-1 secondaryColor"
                              onClick={() =>
              ...
              <Row className="my-1">
                <Col lg={3} md={3} sm={3} xs={3}>
                  <h6 className="primaryColor">Read Only</h6>
                </Col>
                <Col lg={4} md={4} sm={4} xs={4}>
                  <div>
                    <button
                    ...
                    >
                      <form className="form">
                        <div className="form-check dropdown-option-container">
                          ...
                          <input
                            type="checkbox"
                            className="form-check-input me-2 accessibility-input"
                            name="allSelect"
                            checked={
                              !usersList.some(
                      ...
                      if (
                        ...
                        return (
                          <div key={index} className="minibtn mx-2 my-1">
                            ...
                            <span
                              id="accessibilityPopup-crossIcon-removeUser"
                              className="mx-1 secondaryColor"
                              onClick={() =>
          ...
          <Row className="mt-4 accessibility-row">
            <Col md={6}>
